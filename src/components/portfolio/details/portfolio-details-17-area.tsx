...
export default function PortfolioDetailsSeventeenArea() {
  const scrollTo = () => {
  ...
  return (
    <>
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="tp-project-details-3-title-box">
                      <h2 className="tp-section-title-160 mb-50 tp-char-animation">Righteous Properties</h2>
                  </div>
                </div>
            </div>
            <div className="row">
      ...
      <div className="tp-project-details-3-full-width-thumb mb-120">
          <Image data-speed=".8" src={full_image} alt="Righteous Properties" style={{ height: 'auto' }}/>
      </div>
      {/* full image */}
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="showcase-details-2-section-box">
                      <h4 className="showcase-details-2-section-title tp-char-animation">Real Estate Excellence</h4>
                  </div>
                </div>
            </div>
            <div className="row">
                ...
                <div className="col-xl-9">
                  <div className="showcase-details-2-content-right tp_title_anim">
                      <p className="pb-25">Strategic brand development for Righteous Properties, creating a professional real estate identity that builds trust and showcases premium property services.</p>
                      <p>The comprehensive branding solution encompasses logo design, marketing materials, and brand guidelines that establish credibility and attract high-value clients in the competitive real estate market.</p>
                  </div>
                </div>
            </div>
          </div>
            ...
            <div className="row">
                <div className="col-xl-12">
                  <div className="tp-project-details-3-thumb-box">
                    <Image data-speed=".8" src={full_image_2} alt="Righteous Properties branding" style={{ height: 'auto' }}/>
                  </div>
                </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
              <div className="col-xl-8">
                <div className="showcase-details-2-section-box">
                    <h4 className="showcase-details-2-section-title tp-char-animation">Market Impact</h4>
                </div>
              </div>
          </div>
          <div className="row">
              ...
              <div className="col-xl-9">
                <div className="showcase-details-2-content-right tp_title_anim">
                    <p className="pb-25">The new brand identity successfully positioned Righteous Properties as a premium real estate service provider, resulting in increased client inquiries and higher-value property listings.</p>
                    <p>Professional marketing materials and consistent brand application across all touchpoints helped establish market credibility and differentiate from competitors in the local real estate landscape.</p>
                </div>
              </div>
          </div>
        </div>
    ...
    {/* details area */}
     ...
     <div className="pd-visual-slider-wrap pb-40">
              ...
              {slider_images.map((imgSrc, index) => (
                <SwiperSlide key={index}>
                  <div className="pd-visual-slider-thumb fix">
                    <Image src={imgSrc} alt="Righteous Properties portfolio" style={{height:"auto"}}/>
                  </div>
                </SwiperSlide>
              ))}
          </Swiper>
      ...
      <PortfolioNavigation currentPath="/portfolio-details-17" />
      {/* portfolio navigation */}
    </>
  )
}
